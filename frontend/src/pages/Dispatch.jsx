...
import { AlertCircle, Brain, Send, Users, CheckCircle2, Clock, MapPin, Zap } from 'lucide-react'
...
export default function Dispatch() {
  ...
  const handleDispatch = () => {
    ...
    setTimeout(() => { setIsDispatching(false); setDispatched(true) }, 1500)
  }
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <Card className="bg-card/50 backdrop-blur-sm border-white/5 shadow-xl border-t-2 border-t-red-500/50">
        <CardHeader>
          ...
          <CardDescription>Describe the incident in plain language. Our intelligent engine will classify and dispatch instantly.</CardDescription>
        </CardHeader>
        <CardContent>
          <textarea
            ...
            placeholder="e.g.  A child is missing near Sector 5 gate...&#10;       Medical emergency at the main ghat, person unconscious...&#10;       Huge crowd surge near Sector 8 entry..."
            value={incidentText}
        ...
        <CardFooter className="flex justify-end pt-0">
          <Button 
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white gap-2 px-8 h-12 text-base shadow-[0_0_20px_rgba(79,70,229,0.4)] transition-all"
          >
            {isAnalyzing ? (
              ...
              <Card className="bg-indigo-950/40 border-indigo-500/30 h-full">
                ...
                <CardContent className="space-y-5">
                  ...
                  <div className="bg-black/30 rounded-xl p-3">
                    <p className="text-xs text-muted-foreground mb-2 flex items-center gap-1"><MapPin className="w-3 h-3"/> Location</p>
            ...
            <div className="lg:col-span-3">
              <Card className="bg-card/50 backdrop-blur-sm border-white/5 h-full flex flex-col">
                  ...
                  {volunteers.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 text-xs text-amber-400 font-medium">
                        ...
                        Expected response time: {item.response_time}
                      </div>
                    </motion.div>
                  ))}
                </CardContent>
                <CardFooter className="pt-4 border-t border-white/10">
                  ...
                  >
                    {dispatched
                      ? <><CheckCircle2 className="mr-2 w-5 h-5" /> Team Successfully Dispatched!</>
                      : isDispatching
                      ? 'Dispatching...'
